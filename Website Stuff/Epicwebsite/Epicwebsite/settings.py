"""
Django settings for Epicwebsite project.
...
SECRET_KEY = 'django-insecure-t7at=1icl^&%5rlb()k8s$(d-ff%5n!nl%c8s9-5h=z2l%k3cc'
...
WSGI_APPLICATION = 'Epicwebsite.wsgi.application'
